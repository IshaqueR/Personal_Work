...
def makeWord(word,plot=False):
    ...
    for phoneme in word:
        if phoneme == 'AA':#o in odd
            ...
            sound = makeSound(duration=0.34,F0beg=122,F0end=105,f1beg=420,f1end=310,\
            ...
            output.append(sound)
            """
        elif phoneme == 'SIL':#silence for word break
            sound = makeSound(duration=0.34,F0beg=122,F0end=103,f1beg=770,f1end=623,\
                              f2beg=1861,f2end=1788,f3beg=2513,f3end=2513,\
                              bw1beg=138,bw2beg=144,bw3beg=78,Abeg=60,Aend=20,SND="VOW")
            output.append(sound)
        elseif phoneme =='X'
            #append silence here
        else
...
# =============================================================================
        ...
        sa.play_buffer(audio, num_channels=1, bytes_per_sample=2, sample_rate=16_000)
    return audio
